...
## Unreleased
- Modernized homepage into a premium, scrollable portfolio layout (hero + sections) with sticky section navigation.
...
- Improved performance/privacy by removing external font/icon CDNs and removing heavy WakaTime embeds from above-the-fold.
